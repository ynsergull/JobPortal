<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="JobPortal2.User.Login" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlLoginType" runat="server" CssClass="form-control w-100">
                                         ...
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="User Type is required"
                                            ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Front-Size="Small" InitialValue="0" ControlToValidate="ddlLoginType">
