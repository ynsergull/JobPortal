<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="JobPortal2.User.Register" %>
                            ...
                            <di class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">                           
                                        ...
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password does not match!"
                                            ...
                                            Front-Size="Small"></asp:CompareValidator>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtMobilePhone" runat="server" CssClass="form-control" placeholder="Enter Phone Number" required></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" placeholder="Enter Mail" required 
