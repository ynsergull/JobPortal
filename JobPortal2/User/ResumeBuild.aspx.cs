            ...
            try
            {
                ...
                if (sdr.HasRows)
                {
                    if (sdr.Read())
                    {
                        ...
                        txtMobilePhone.Text = sdr["Mobile"].ToString();
                        txtTenth.Text = sdr["TenthGrade"].ToString();
                        txtTwelft.Text = sdr["TwelftGrade"].ToString();
            ...
            try
            {
                if (Request.QueryString["id"] != null)
                {
                    ...
                    query = @"Update [User] set Username=@Username,Name=@Name,Email=@Email,Mobile=@Mobile,
                            TenthGrade=@TenthGrade,TwelftGrade=@TwelftGrade,GraduationGrade=@GraduationGrade,
                            PostGraduationGrade=@PostGraduationGrade,Phd=@Phd,WorksOn=@WorksOn,Experience=@Experience,
                    ...
                    cmd.Parameters.AddWithValue("TwelftGrade", txtTwelft.Text.Trim());
                    ...
                    if (isValid)
                    {
                        ...
                        {
                            lblMsg.Visible = true;
                            lblMsg.Text = "Resume detail updated successful!";
