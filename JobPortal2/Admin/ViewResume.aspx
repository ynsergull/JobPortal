<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ViewResume.aspx.cs" Inherits="JobPortal2.Admin.ViewResume" %>
                ...
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Email" HeaderText="User Eamil">
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
