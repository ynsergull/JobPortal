<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="JobPortal2.Admin.NewJob" %>
...
<%--            <div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                 ...
                 <div class="col-md-6 pt-3">
                    <label for="txtOfNoPost" style="font-weight:600">Number Of Post</label>
                    <asp:TextBox ID="txtOfNoPost" runat="server" CssClass="form-control" placeholder="Enter Number Of Position" TextMode="number" required></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                 ...
                 <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex: 2 year, 3.5 years" TextMode="number" required></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex: $25000/Month" TextMode="MultiLine" required></asp:TextBox>
                </div>
                 <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder="Enter Company/Organisation Name" TextMode="MultiLine" required></asp:TextBox>
                </div>
                 <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtWebsite" runat="server" CssClass="form-control" placeholder="Enter Website" TextMode="Url" required></asp:TextBox>
                </div>
                 <div class="col-md-6 pt-3">
